...
function CustomerAuthModal({onLogin, onClose, redirectVendor=null, onVendorLogin=null}) {
  ...
  function handleBackdropClick(e){
    // Only close if the click landed directly on the backdrop div itself
  ...
  return (
    <div ref={backdropRef} onClick={handleBackdropClick} style={{position:'fixed',inset:0,background:'rgba(22,32,24,0.55)',zIndex:1000,display:'flex',alignItems:'center',justifyContent:'center',backdropFilter:'blur(3px)'}}>
...
function QuoteModal({vendor,customer,onClose,onSubmitted}) {
  ...
  return(
    <div ref={backdropRef} onClick={handleBackdropClick} style={{position:'fixed',inset:0,background:'rgba(22,32,24,0.6)',zIndex:1000,display:'flex',alignItems:'center',justifyContent:'center',backdropFilter:'blur(4px)',padding:'20px'}}>
