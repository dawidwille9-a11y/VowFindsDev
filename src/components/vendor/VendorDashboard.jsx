                ...
                {myVendors.map(v => (
                  <div key={v.id} style={{ display:'flex', alignItems:'center', gap:10, padding:'10px', borderRadius:10, border:'1.5px solid var(--parchment)', background:'var(--cream)' }}>
                    ...
                    <div style={{ display:'flex', gap:6, flexShrink:0 }}>
                      ...
                      <button onClick={e => { e.stopPropagation(); deleteVendor(v.id); }} style={{ background:'#fce8e4', color:'#b85a45', border:'none', borderRadius:7, padding:'7px 9px', fontSize:'0.74rem', cursor:'pointer', display:'flex', alignItems:'center', gap:4 }}>
                        {IC.trash(12,'#b85a45')}
                      </button>
                    </div>
                  </div>
