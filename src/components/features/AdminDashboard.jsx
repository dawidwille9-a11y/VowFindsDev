  ...
  return(
    <div style={{padding:'24px',maxWidth:720,margin:'0 auto',display:'flex',flexDirection:'column',gap:24}}>
      ...
      <div style={{background:'rgba(201,169,110,0.08)',borderRadius:12,padding:'16px 20px',fontSize:'0.82rem',color:'var(--mid)',lineHeight:1.8,border:'1px solid rgba(201,169,110,0.2)'}}>
        ...
        1. Keep paywall <strong>OFF</strong> while signing up early vendors — they list for free.<br/>
        2. When ready to launch billing, turn paywall <strong>ON</strong>.<br/>
        3. Vendors signed up during the free phase will hit the payment wall on next login. They will see the 3-month free trial offer and only pay after 3 months.<br/>
        4. Use the <strong>+3mo trial</strong> button above to manually extend a specific vendor if needed.
      </div>
    </div>
  );
}
