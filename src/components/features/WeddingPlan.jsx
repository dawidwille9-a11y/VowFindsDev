        ...
        <div style={{background:'var(--white)',borderRadius:16,boxShadow:'var(--card-shadow)',padding:'28px'}}>
          ...
          {budget>0&&(
            <div style={{background:'rgba(58,74,63,0.05)',borderRadius:10,padding:'14px 16px',marginBottom:20,border:'1px solid rgba(58,74,63,0.1)'}}>
              ...
              {/* Venue first */}
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',fontSize:'0.8rem',borderBottom:'1px solid rgba(58,74,63,0.06)',background:'rgba(201,169,110,0.08)',margin:'0 -4px',padding:'5px 4px',borderRadius:4}}>
