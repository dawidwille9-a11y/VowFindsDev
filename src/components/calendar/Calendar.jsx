...
import { MONTHS, DOWS } from '../../constants.js';
    ...
    <div style={{width:'100%',boxSizing:'border-box'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(7,1fr)',gap:3}}>
        ...
        {Array.from({length:days},(_,i)=>i+1).map(day=>{
          ...
          if(isW){bg='var(--forest)';color='var(--gold-light)';fw=700;}else if(isU){bg='#e8352a';color='#ffffff';fw=700;}
      ...
      <div style={{display:'flex',gap:12,flexWrap:'wrap',marginTop:12}}>
        <div style={{display:'flex',alignItems:'center',gap:5,fontSize:'0.72rem',color:'var(--mid)'}}><div style={{width:10,height:10,borderRadius:3,background:'#e8f5e9',border:'1.5px solid #4caf50'}}/>Available</div>
        <div style={{display:'flex',alignItems:'center',gap:5,fontSize:'0.72rem',color:'var(--mid)'}}><div style={{width:10,height:10,borderRadius:3,background:'#e8352a'}}/>Unavailable</div>
