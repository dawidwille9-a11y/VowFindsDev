...
export const BOOKING_ORDER = [
  {step:2,  type:'Venue',          note:'Your venue sets the tone for your entire wedding day — it determines your guest count, style and date.',    why:'Popular venues book out 12–24 months in advance. Securing your venue is the single most important first step.'},
  {step:3,  type:'Photography',     note:'Your photographer captures memories that last a lifetime.',                                              why:'Top photographers book 12+ months ahead. Locking this in early gives you the best selection.'},
