        ...
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.45)',zIndex:500,display:'flex',alignItems:'flex-end',justifyContent:'center'}}>
          <div style={{background:'#fff',borderRadius:'20px 20px 0 0',padding:'24px 20px 32px',width:'100%',maxWidth:480,boxShadow:'0 -8px 40px rgba(0,0,0,0.15)'}}>
            ...
            <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12}}>
              {IC.pin(20,'var(--rose)')}
              <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'1.2rem',fontWeight:600,color:'var(--forest)'}}>Venue required for accurate pricing</div>
            </div>
            <p style={{fontSize:'0.84rem',color:'var(--mid)',lineHeight:1.65,marginBottom:20}}>
            ...
            <button onClick={()=>{setVenuePrompt(false);onBack();}}
              style={{width:'100%',background:'var(--forest)',color:'var(--gold-light)',border:'none',borderRadius:12,padding:'14px',fontFamily:"'DM Sans',sans-serif",fontSize:'0.92rem',fontWeight:600,cursor:'pointer',marginBottom:10}}>
              Add my venue
            </button>
            <button onClick={()=>{setVenuePrompt(false);if(pendingVendor)onOpen(pendingVendor);}}
              style={{width:'100%',background:'none',border:'1.5px solid #e0dbd4',borderRadius:12,padding:'12px',fontFamily:"'DM Sans',sans-serif",fontSize:'0.88rem',color:'var(--mid)',cursor:'pointer'}}>
...
function GlobalStyles(){return(
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    body{font-family:'DM Sans',sans-serif;background:var(--cream);color:#2c2c2c;color-scheme:light only;forced-color-adjust:none;}
    ...
    *{forced-color-adjust:none;}
    @media(prefers-color-scheme:dark){
      ...
      body{background:#faf6f1!important;color:#2c2c2c!important;color-scheme:light only!important;}
