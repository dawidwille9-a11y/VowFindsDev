...
export const BOOKING_ORDER = [
  {step:1,  type:'Venue',          note:'Your venue sets the tone for your entire wedding day — it determines your guest count, style and date.',    why:'Popular venues book out 12–24 months in advance. Securing your venue is the single most important first step.'},
  {step:2,  type:'Photography',     note:'Your photographer captures memories that last a lifetime.',                                              why:'Top photographers book 12+ months ahead. Locking this in early gives you the best selection.'},
  {step:3,  type:'Catering',        note:'Food and drink is often the most talked-about part of a wedding reception.',                             why:'Caterers need lead time for menu planning, sourcing, and staffing for your guest count.'},
  {step:4,  type:'Coordinator',     note:'A coordinator ties every detail together so you can be present on your day.',                           why:'Good coordinators book fast — the earlier you hire one, the more planning support you get.'},
  {step:5,  type:'Florist',         note:'Flowers set the mood — from the ceremony arch to table centrepieces and your bridal bouquet.',           why:'Florals require detailed planning and sourcing. Book early to secure your preferred style and blooms.'},
  {step:6,  type:'Videography',     note:'A wedding film lets you relive every moment — sound, movement, and emotion — for years to come.',        why:'Great videographers are often booked alongside photographers and fill calendars quickly.'},
  {step:7,  type:'Attire',          note:'Your dress or suit is one of the most personal choices you will make — give yourself time to find the one.', why:'Custom and made-to-measure outfits need 3–6 months for fittings and alterations.'},
  {step:8,  type:'DJ',              note:'Your DJ keeps the energy alive from the first dance to the last song.',                                  why:'Great DJs fill their weekends fast, especially in peak season.'},
  {step:9,  type:'Entertainment',   note:'Pre-drinks entertainment keeps guests engaged while you finish photos — bands, soloists, or acts.',      why:'Live entertainers book up quickly for peak wedding season. Unique acts are limited.'},
  {step:10,  type:'Cake & Desserts', note:'Your cake is a centrepiece and a treat. Custom designs take time and careful planning.',                 why:'Custom wedding cakes require design sessions, tastings, and preparation weeks in advance.'},
