    ...
    <div style={{position:'fixed',inset:0,display:'flex',flexDirection:'column',background:'#f8f6f3',fontFamily:"'DM Sans',sans-serif"}}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        html,body,#root{background:#f8f6f3 !important;color:#1c2b22 !important;color-scheme:light only !important;}
        .pac-container{z-index:9999!important;font-family:'DM Sans',sans-serif;}
        input,textarea,select,button{color-scheme:light;font-family:'DM Sans',sans-serif;}
