// ── config.js — API keys ─────────────────────────────────────────────────────
// ⚠️  Move these to Vercel Environment Variables before going live
//    Settings → Environment Variables → VITE_SUPABASE_URL etc.
//    Then replace values with: import.meta.env.VITE_SUPABASE_URL
