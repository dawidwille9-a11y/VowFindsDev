              ...
              <div style={{display:'grid',gap:14}}>
                {[...vendor.packages]
                  ...
                  .map((pkg,i)=>{
                    ...
                    return(
                      <div key={pkg.id||i} style={{background:'var(--white)',borderRadius:14,padding:'20px 22px',boxShadow:'var(--card-shadow)',border:`2px solid ${isLowest?'var(--forest)':'var(--parchment)'}`}}>
                  ...
                  .map((pkg,i)=>{
                    ...
                    return(
                      <div key={pkg.id||i} style={{borderRadius:10,padding:'10px 12px',marginBottom:8,
                        background:i===0?'rgba(58,74,63,0.05)':'var(--cream)',
                        border:`1.5px solid ${i===0?'var(--forest)':'var(--parchment)'}`}}>
