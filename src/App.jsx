...
import { supaFetch, getBatchDistancesKm, loadSession, saveSession, clearSession } from './api.js';
...
export default function VowFinds() {
  ...
  // Load session on mount (cannot use lazy useState initializer due to module bundling)
  useEffect(()=>{
