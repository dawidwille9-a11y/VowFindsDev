...
function VendorDetail({vendor,dateFrom,dateTo,venueLabel,venueLatLng,onBack,onRequestQuote}) {
  ...
  return (
    <div style={{background:'var(--cream)',minHeight:'100vh'}}>
      ...
      <div className="vf-vendor-detail-hero" style={{position:'relative',height:300,overflow:'hidden',marginTop:0,background:galleryImgs[0]?.url?`url(${galleryImgs[0].url}) center/cover`:`linear-gradient(140deg,${vendor.color||'#c8a87a'}ff,${vendor.color||'#c8a87a'}88)`}}>
